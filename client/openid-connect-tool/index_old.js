...
function getProfile() {
    ...
    action = function () {
        var x = $.get(userInfoUrl, profileRequest)
            .done(function (data) {
            })
            .fail(function (data) {
            })
...
function pullSettingsFromUI() {
  ...
  tokenUrl = protocolUrl + '/oidc/accessToken';
  //authUrl = protocolUrl + '/auth';
  //authUrl = protocolUrl + '/oidc/authorize';
  authUrl = 'http://cas1:8080/cas/oidc/authorize';
  //userInfoUrl = protocolUrl + '/oidc/userinfo';
  userInfoUrl = protocolUrl + '/oidc/profile';
  logoutUrl = protocolUrl + '/oidc/logout';
}
